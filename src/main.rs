...
use windows_sys::Win32::Security::Cryptography::{
    ...
    CERT_SYSTEM_STORE_CURRENT_USER, CertAddEncodedCertificateToStore, CertCloseStore,
    CertDeleteCertificateFromStore, CertOpenStore, HCERTSTORE, PKCS_7_ASN_ENCODING,
    X509_ASN_ENCODING,
};
